...
- Нельзя отменить отправку голосового.
- надо каждый раз кликать в поле ввода для отправки сообщений.
- нельзя вставить скриншот.
- задний фон при открытие чата скрывать.
- предпросмотр не работает.
- после отправки большого сообщения поле ввода не возвращается к дефолтному размеру.
