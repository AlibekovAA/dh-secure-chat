...
- **Отправка файлов**
  ...
  - **Видео-кружки**:
    ...
    - при клике на видео-кружку открывается модальное окно с HTML5 видеоплеером;
...
- SPA с основными модулями:
  ...
  - видео-кружки для отображения видео файлов с автоматической генерацией превью и lazy loading;
...
- Запись видео сообщений (аналогично голосовым сообщениям).
