...
- Все сообщения и файлы шифруются на клиенте.
...
- Сервер **никогда не может расшифровать** сообщение или файл.
- Файлы разбиваются на чанки и шифруются по частям для эффективной передачи.
...
- SPA с основными модулями:
  ...
  - E2E‑шифрование/дешифрование сообщений и файлов;
...
- **Chat‑service**
  ...
  - WebSocket‑hub для:
    ...
    - маршрутизации зашифрованных сообщений и файлов 1‑на‑1;
    - служебных сообщений (ephemeral ключи, acknowledge, статусы доставки/онлайна);
    - передачи файлов по частям (file_start, file_chunk, file_complete);
